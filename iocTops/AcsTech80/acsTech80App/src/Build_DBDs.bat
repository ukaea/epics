...
SET BUILDIR=C:\Users\ktn98257\source\repos\epics.dotnet\iocTops\AcsTech80\AcsTech80App\src
...
perl -CSD %DLLDIR%dbdExpand.pl -I. -I.. -I..\O.Common -I%TOPLEVEL%DBD -o .\O.Common\acsTechIOC.dbd  base.dbd calcSupport.dbd asSupport.dbd 
