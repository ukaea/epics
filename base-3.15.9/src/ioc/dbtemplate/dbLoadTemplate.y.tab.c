...
#line 59 "dbLoadTemplate.y.tab.c"
#define WORD 257
#define QUOTE 258
#define DBFILE 259
#define PATTERN 260
...
#line 312 "dbLoadTemplate.y.tab.c"
...
break;
#line 662 "dbLoadTemplate.y.tab.c"
    }
    yyssp -= yym;
    yystate = *yyssp;
    yyvsp -= yym;
