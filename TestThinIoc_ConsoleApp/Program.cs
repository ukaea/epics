...
namespace TestThinIoc_ConsoleApp
{
  ...
  public class Program
  {
    ...
    public static void Main ( string[] args ) 
    {
      ...
      SetDllDirectory("C:\\Users\\steve\\source\\repos\\epics.dotnet\\x64\\Debug_DLL") ;
    ...
    static extern bool SetDllDirectory ( [MarshalAs(UnmanagedType.LPStr)] string pathToSearch ) ;
    ...
    static extern int thin_ioc_start ( 
      ...
      int                                             nDbDescriptors,
      [MarshalAs(UnmanagedType.LPStr)] string?        pathToCmdFile = null,
      [MarshalAs(UnmanagedType.LPStr)] string?        pathToDbdFile = null
    ) ;
