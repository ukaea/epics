...
typedef enum {
	...
	asynRecordADDR = 49,
	asynRecordPCNCT = 50,
	asynRecordDRVINFO = 51,
	asynRecordREASON = 52,
	asynRecordTMOD = 53,
	asynRecordTMOT = 54,
	asynRecordIFACE = 55,
	asynRecordOCTETIV = 56,
	asynRecordOPTIONIV = 57,
	asynRecordGPIBIV = 58,
	asynRecordI32IV = 59,
	asynRecordUI32IV = 60,
	asynRecordF64IV = 61,
	...
	asynRecordI32INP = 80,
	asynRecordI32OUT = 81,
	asynRecordUI32INP = 82,
	asynRecordUI32OUT = 83,
	asynRecordUI32MASK = 84,
	asynRecordF64INP = 85,
	asynRecordF64OUT = 86,
	asynRecordBAUD = 87,
	asynRecordLBAUD = 88,
...
static int asynRecordSizeOffset(dbRecordType *prt)
{
    ...
    prt->papFldDes[asynRecordAMSG]->offset = (unsigned short)((char *)&prec->amsg - (char *)prec);
    ...
    prt->papFldDes[asynRecordNAMSG]->offset = (unsigned short)((char *)&prec->namsg - (char *)prec);
