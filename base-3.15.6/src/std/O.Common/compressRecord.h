...
typedef enum {
	...
	compressRecordNSAM = 49,
	compressRecordN = 50,
	compressRecordIHIL = 51,
	compressRecordILIL = 52,
	compressRecordHOPR = 53,
	compressRecordLOPR = 54,
	compressRecordPREC = 55,
	compressRecordEGU = 56,
	compressRecordOFF = 57,
	compressRecordNUSE = 58,
	compressRecordOUSE = 59,
	compressRecordBPTR = 60,
	compressRecordSPTR = 61,
	compressRecordWPTR = 62,
	compressRecordINPN = 63,
	compressRecordCVB = 64,
	compressRecordINX = 65
} compressFieldIndex;
