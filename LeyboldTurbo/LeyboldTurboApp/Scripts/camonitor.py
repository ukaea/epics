...
for Pump in range(1, int(NumPumps)+1):
	...
	epics.camonitor('TURBO:' + str(Pump) + ':FaultStr')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningTemperature')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningTemperatureStr')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningHighLoad')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningHighLoadStr')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningPurge')
	epics.camonitor('TURBO:' + str(Pump) + ':WarningPurgeStr')
