/* This file was generated by running configure in Nexus 4.3.1 on a Fedora 15 system 
 *  for both 32-bit and 64-bit builds and then merging the results into a single file 
 * using __LP64__ to test which architecture is being used.
 */
