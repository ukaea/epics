/* This file was generated by running configure for 32-bit Fedora 15 and then editing for vxWorks */
...
# endif
#endif
/* Assume vxWorks is running on Motorola processor, not Intel */
#define WORDS_BIGENDIAN 1
