...
cl -C -E -nologo -D__STDC__=0 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -I./O.Common -I%TOPLEVEL%include/compiler/msvc -I%TOPLEVEL%include/os/WIN32 -I%TOPLEVEL%include -I%TOPLEVEL%include/os/WIN32  EnsembleTrajectoryScan.st > O.Common\EnsembleTrajectoryScan.i
