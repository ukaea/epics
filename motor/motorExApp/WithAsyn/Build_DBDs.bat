...
perl -CSD %DLLDIR%dbdExpand.pl  -I. -I.. -I..\O.Common -I%TOPLEVEL%DBD  -o O.Common\WithAsyn.dbd base.dbd motorSupport.dbd drvAsynSerialPort.dbd drvAsynIPPort.dbd busySupport.dbd
