...
epicsShareExtern rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_longoutRSET, *pvar_rset_mbbiRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_longoutRecordSizeOffset, pvar_func_mbbiRecordSizeOffset,
    pvar_func_mbbiDirectRecordSizeOffset, pvar_func_mbboRecordSizeOffset,
    pvar_func_mbboDirectRecordSizeOffset,
    pvar_func_permissiveRecordSizeOffset, pvar_func_selRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "longout", "mbbi", "mbbiDirect", "mbbo", "mbboDirect", "permissive",
...
static const char * const deviceSupportNames[] = {
    ...
    "devLiGeneralTime", "devLoSoft", "devLoSoftCallback", "devMbbiSoft",
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_dbndInitialize, pvar_func_dlloadRegistar,
    pvar_func_iocshSystemCommand, pvar_func_syncInitialize,
...
int softIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "D:/EPICS/asyn/";
...
{
    softIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
